...
\begin{frame}
    ...
    \only<1-3>{\visible<3>{\includegraphics[height=4em]{imgs/lics2022}}}
    \only<4>{\includegraphics[height=4em]{imgs/csl2023}}
    \only<5>{\includegraphics[height=4em]{imgs/lics2023}}
    \only<6>{\includegraphics[height=4em]{imgs/popl2024}}
    \only<7>{\includegraphics[height=4em]{imgs/lics2024}}
    \only<8>{\includegraphics[height=8em]{imgs/sheaves}}
